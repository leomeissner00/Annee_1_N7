...
;; append_Nil_left
  (assert (forall ((l (liste a))) (= (append1 Nil1 l) l)))

;; append_Nil_left
  (assert (forall ((a2 ty)) (forall ((l uni)) (= (append a2 (Nil a2) l) l))))

;; append_Cons_left
  (assert
  (forall ((e a))
  (forall ((l1 (liste a)) (l2 (liste a)))
  (= (append1 (tb2t (Cons a1 (t2tb1 e) (t2tb l1))) l2) (tb2t
                                                       (Cons a1 (t2tb1 e)
                                                       (t2tb (append1 l1 l2))))))))
...
;; append_Cons_left
  ...
  (= (append a2 (Cons a2 e l1) l2) (Cons a2 e (append a2 l1 l2)))))))

(assert
;; append_Nil_right
 ;; File "induction_etu/../induction_etu.mlw", line 18, characters 6-22
  (not (forall ((l (liste a))) (= (append1 l Nil1) l))))
(check-sat)
