...
procedure compresser is 
	...
	--Nom: Afficher_abr
	--Sémantique: Afficher l'arbre de huffmann sur la console
	--Paramètres: arbre_bin : in Arbre.T_Abr; chemin : in out Unbounded_String
	...
	--Nom: Afficher_code
	--Sémantique: Afficher la table de codage sur la console
	--Paramètres: Donnee: in Unbounded_String ; Cle : in Unbounded_String
	...
	--Sémantique: Convertis un octet en chaine de caractère de binaire
	...
	--Sémantique: Convertis une chaine de caractère de binaire en octet
	--Paramètres: Binaire : in Unbounded_String
	...
	--Nom: Creation_tableau_frequence
	--Sémantique: Créer le tableau de fréquence des caractère 
	--Paramètres: Nom_fichier : in Unbounded_String; table_frequence : in out LCA_frequence.T_LCA
	...
	--Nom: Min_frequence
	--Sémantique: Donnee la clé de l'arbre avec la plus petite fréquence
	--Paramètres: Cle : in out Unbounded_String; table_abr : in LCA_arbre.T_LCA
	...
	--Nom: FrequenceToArbre
	--Sémantique: Créer une liste d'arbre avec les clés et données de table_frequence
	--Paramètres: table_frequence : in out LCA_frequence.T_LCA; liste_abr : in out LCA_arbre.T_LCA
	...
	--Nom: Arbre_Huffman
	--Sémantique: Créer l'arbre Huffman à partir de la liste des arbres 
	--Paramètres: liste_abr : in out LCA_arbre.T_LCA; arbre_bin : in out Arbre.T_Abr
	...
	--Nom: Parcours_infixe
	--Sémantique: Fais le parcours infixe pour créer la table de Huffman et avoir les caractère dans l'ordre infixe
	--Paramètres: arbre_bin : in out T_Abr ; suite_bits : in out Unbounded_String ; code : in out Unbounded_String ; table_Huffman : in out LCA_codage.T_LCA; caractere : in out Unbounded_String
	...
	--Nom: Compression_texte
	--Sémantique: Fais la compression du texte
	--Paramètres: SC : In Stream_Access; Nom_fichier : in Unbounded_String; table_Huffman : in out LCA_codage.T_LCA; caractere : in out Unbounded_String
...
begin
	...
	vider(arbre_bin);
	LCA_codage.vider(table_Huffman);
	LCA_frequence.vider(table_frequence);
	LCA_arbre.Vider(liste_abr);
