...
package body Vecteurs_Creux is
        ...
        begin
                if not Est_Nul(V) then  -- TODO : à changer
        ...
        procedure Modifier (V : in out T_Vecteur_Creux ;
                ...
                begin
                        ...
                        Initialiser(ptr);	--+ TODO : à changer
                        ptr.Indice := Indice;
                        ptr.Valeur := Valeur;
                        ptr := V;
                        while not Est_Nul(ptr) loop
                                if ptr.Indice > V.Indice then
                                        ptr := V.Suivant;
                                elsif ptr.Indice = V.Indice then
                                        V.Valeur := ptr.Valeur;
                                end if;
                        end loop;
                        if ptr.Indice > V.Indice then
