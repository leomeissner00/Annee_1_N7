...
begin
  ...
  --Afficher_Deux_Positions (2);     --Afficher_Deux_Positions n'est pas un programme utilisable par l'utilisateur car il ne figure pas dans le .ads de dates
    New_Line;
  ...
  --  Une_Date.jour := 15;          --Une_Date est private donc on ne peut pas modififer son contenu comme cela
