...
indC = find (V_chrysanthemes >= V_pensees & V_chrysanthemes >= V_oeillets);
indO = find(V_oeillets >= V_pensees & V_oeillets >= V_chrysanthemes);
indP = find(V_pensees >= V_oeillets & V_pensees >= V_chrysanthemes);
