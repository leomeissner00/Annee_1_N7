        ...
        try {
            ...
            if (n >= 2) {
                ...
                if (n >= 14) {
                    ...
                    if (formule.substring(0, 8).equals("MOYENNE(") && formule.charAt(n-1) == ')' ) {
                        String[] cells = formule.substring(8,n-1).split(",");
                        if (cells.length != 2) {
                            throw new FormatFormuleException("Format MOYENNE invalide");
                        }
                        String[] cell1 = cells[0].split(":");
                        String[] cell2 = cells[1].split(":");
                        if (cell1.length != 2 || cell2.length != 2) {
                            throw new FormatFormuleException("Format cellule dans MOYENNE invalide");
                        }
                        try {
                            Position p1 = new Position(Integer.parseInt(cell1[0]), Integer.parseInt(cell1[1]));
                            Position p2 = new Position(Integer.parseInt(cell2[0]), Integer.parseInt(cell2[1]));
                            return new FormuleMoyenne(p1, p2);
                        } catch (NumberFormatException e2) {
                            throw new FormatFormuleException("Les indices d'une cellules doivent etre des entiers");
                        }
                    }
                   /* if (formule.substring(0, 8).equals("PRODUIT(") && formule.charAt(n-1) == ')' ){
                        String[] cells = formule.substring(8,n-1).split(",");
                        if (cells.length != 2) {
                            throw new FormatFormuleException("Format PRODUIT invalide");
                        }
                        String[] cell1 = cells[0].split(":");
                        String[] cell2 = cells[1].split(":");
                        if (cell1.length != 2 || cell2.length != 2) {
                            throw new FormatFormuleException("Format cellule dans PRODUIT invalide");
                        }
                        try {
                            Position p1 = new Position(Integer.parseInt(cell1[0]), Integer.parseInt(cell1[1]));
                            Position p2 = new Position(Integer.parseInt(cell2[0]), Integer.parseInt(cell2[1]));
                            return new FormuleProduit(p1, p2);
                        } catch (NumberFormatException e2) {
                            throw new FormatFormuleException("Les indices d'une cellules doivent etre des entiers");
                        }
                    }*/
                   /* if (formule.substring(0, 9).equals("VARIANCE(") && formule.charAt(n-1) == ')' ){
                        String[] cells = formule.substring(8,n-1).split(",");
                        if (cells.length != 2) {
                            throw new FormatFormuleException("Format VARIANCE invalide");
                        }
                        String[] cell1 = cells[0].split(":");
                        String[] cell2 = cells[1].split(":");
                        if (cell1.length != 2 || cell2.length != 2) {
                            throw new FormatFormuleException("Format cellule dans VARIANCE invalide");
                        }
                        try {
                            Position p1 = new Position(Integer.parseInt(cell1[0]), Integer.parseInt(cell1[1]));
                            Position p2 = new Position(Integer.parseInt(cell2[0]), Integer.parseInt(cell2[1]));
                            return new FormuleVariance(p1, p2);
                        } catch (NumberFormatException e2) {
                            throw new FormatFormuleException("Les indices d'une cellules doivent etre des entiers");
                        }
                    }*/
                   /* if (formule.substring(0, 10).equals("ECARTTYPE(") && formule.charAt(n-1) == ')' ){
                        String[] cells = formule.substring(8,n-1).split(",");
                        if (cells.length != 2) {
                            throw new FormatFormuleException("Format ECARTTYPE invalide");
                        }
                        String[] cell1 = cells[0].split(":");
                        String[] cell2 = cells[1].split(":");
                        if (cell1.length != 2 || cell2.length != 2) {
                            throw new FormatFormuleException("Format cellule dans ECARTTYPE invalide");
                        }
                        try {
                            Position p1 = new Position(Integer.parseInt(cell1[0]), Integer.parseInt(cell1[1]));
                            Position p2 = new Position(Integer.parseInt(cell2[0]), Integer.parseInt(cell2[1]));
                            return new FormuleEcartType(p1, p2);
                        } catch (NumberFormatException e2) {
                            throw new FormatFormuleException("Les indices d'une cellules doivent etre des entiers");
                        }
                    }*/
