...
public class FormuleMoyenne extends Formule {
	
	private Position position1;
    private Position position2;
    
    public FormuleMoyenne(Position pos1, Position pos2) {
        super();
        this.position1 = pos1;
        this.position2 = pos2;
	...
	public String toString() {
		return "MOYENNE(" + position1.toString() + "," + position2.toString() + ")";
	}
