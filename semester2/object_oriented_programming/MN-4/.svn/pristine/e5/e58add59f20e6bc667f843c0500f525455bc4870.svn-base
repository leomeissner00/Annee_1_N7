...
public class FormuleVariance implements Formule {
	
	private Position position1;
    private Position position2;
    
    public FormuleVariance(Position pos1, Position pos2) {
        super();
        this.position1 = pos1;
        this.position2 = pos2;
	...
	public String toString() {
		return "VARIANCE(" + position1.toString() + "," + position2.toString() + ")";
	}
