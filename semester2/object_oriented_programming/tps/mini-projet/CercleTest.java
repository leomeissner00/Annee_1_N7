...
public class CercleTest {
	...
	@Test public void testerE13_1() {
		...
		memesCoordonnees("E13 : Centre de C2 incorrect", new Point(-2.5, -2.5), C5.getCentre());
		assertEquals("E13 : Rayon de C2 incorrect",
				2.5*Math.sqrt(2), C5.getRayon(), EPSILON);
		assertEquals(Color.black, C5.getCouleur());
	}
	...
	@Test public void testerE14_2() {
		...
		C3 = Cercle.creerCercle(G, I);
		memesCoordonnees("E14 : Centre de C3 incorrect", G, C3.getCentre());
		assertEquals("E14 : Rayon de C3 incorrect",
				10*Math.sqrt(2), C3.getRayon(), EPSILON);
		assertEquals(Color.blue, C3.getCouleur());
		
		C3 = Cercle.creerCercle(F, I);
		memesCoordonnees("E14 : Centre de C3 incorrect", F, C3.getCentre());
		assertEquals("E14 : Rayon de C3 incorrect",
				5*Math.sqrt(2), C3.getRayon(), EPSILON);
		assertEquals(Color.blue, C3.getCouleur());
