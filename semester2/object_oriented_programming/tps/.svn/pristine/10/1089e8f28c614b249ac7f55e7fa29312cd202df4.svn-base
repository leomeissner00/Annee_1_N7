...
public class ExempleComprendre {
	...
	public static void main(String[] args) {
		...
		p1.setY(10);
		afficher("p1", p1);
										// Dessiner l'état de la mémoire: On a p1 -> (0, 10) et p2 -> (0, 0)
		...
		afficher("p1", p1);		// Qu'est ce qui est affiché ? p1 = (100, 110)
										...
										// Dessiner l'état de la mémoire   On a p1 -> (100, 110) et p2 -> (0, 0) et p3 -> (100, 110)
		...
		p1 = p2 = p3;
										// Dessiner l'état de la mémoire On a p1 -> (123, 321) et p2 -> (123, 321) et p3 -> (123, 321)

		afficher("p1", p1);		// Qu'est ce qui est affiché ? p1 = (123, 321)
		afficher("p2", p2);		// Qu'est ce qui est affiché ?p2 = (123, 321)
		afficher("p3", p3);		// Qu'est ce qui est affiché ? p3 = (123, 321)

		// p1, p2 et p3 sont-ils des points différents ? Non
