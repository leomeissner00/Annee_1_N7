...
public class Segment {
	...
	*/
	...
	/**Dessiner un segement sur un Écran
	    * 	
	    * @param vEcran
	    */
		public void dessiner(Ecran vEcran) {
		vEcran.dessinerLigne(this.extremite1.getX(), this.extremite1.getY(),this.extremite2.getX(), this.extremite2.getY() , this.couleur);
		}
	...
	/**Dessiner un segement sur un Écran
	    ...
	    * @param vEcran
	    */
		public void dessinerSVG(AfficheurSVG vEcran) {
		vEcran.dessinerLigne(this.extremite1.getX(), this.extremite1.getY(),this.extremite2.getX(), this.extremite2.getY() , this.couleur);
		}
